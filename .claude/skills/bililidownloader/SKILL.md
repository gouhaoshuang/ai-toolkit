...
# 指定输出目录
python3 scripts/download_bilibili.py "https://www.bilibili.com/video/BV1xxx" -o "D:\code\ai-toolkit\output"

# 批量下载到指定目录
python3 scripts/download_bilibili.py "https://www.bilibili.com/video/BV1xxx" --batch -o "D:\code\ai-toolkit\output"
```

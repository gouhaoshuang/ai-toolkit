...
def main():
    ...
    parser.add_argument("--output", "-o", dest="output_dir", default="./", help="Output directory for downloaded videos")
    ...
    if is_playlist:
        ...
        if batch_download:
            ...
            if formats:
                ...
                # 执行批量下载
                success = download_playlist(url, format_choice, output_dir)
            ...
            if formats:
                ...
                # 执行下载
                success = download_video(url, format_choice, output_dir)
